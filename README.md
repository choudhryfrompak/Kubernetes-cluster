...
- After getting the root access paste the command you make from this template
```bashrc
curl -sfL https://get.k3s.io | K3S_TOKEN="YOUR_TOKEN" K3S_URL="https://[ip of master]:6443" K3S_NODE_NAME="workernodename" sh -s
```
...
https://www.dropbox.com/scl/fi/cx14gav48z52ba0cgxn6r/cluster_paf-iast_edu_pk.zip?rlkey=bsi74oi4w17jgvgjabdmwmuwy&st=7mpdzcw6&dl=1




https://drive.google.com/drive/folders/1VOGFVqHMcs7va9I-ViLGgNVJ0wAbbFgX?usp=drive_link
https://drive.google.com/drive/folders/1FTtR5w4dOKc_94fObNFBM9rOCIWDc16n?usp=drive_link
